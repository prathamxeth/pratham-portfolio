...
export default function WorkPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 md:py-16 space-y-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-6 border-b border-[var(--neutral-border)]">
        ...
        {filteredProjects.map((project) => (
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="text-xl sm:text-2xl font-bold text-[var(--neutral-strong)] group-hover:text-[var(--brand-primary)] transition-colors">
                {project.title}
              </h2>
            ...
            {/* Tech Tags & Links */}
            <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-[var(--neutral-border)]">
              ...
              <div className="flex items-center gap-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="liquid-button px-4 py-2 rounded-xl text-xs font-medium flex items-center gap-1.5 text-[var(--neutral-strong)]"
                >
                ...
                {project.liveUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-4 py-2 rounded-xl text-xs font-medium bg-[var(--neutral-strong)] text-[var(--background)] hover:opacity-90 transition-opacity flex items-center gap-1.5 shadow-md"
                  >
                    <span>Live Demo</span>
