  ...
  return (
    <section id="experience" className="py-12 space-y-8">
      <div className="space-y-1">
        <h2 className="text-2xl font-bold tracking-tight text-(--neutral-strong)">
          Experience & Studies
        </h2>
        ...
        {experiences.map((exp, idx) => {
          ...
          return (
            <div key={exp.company} className="magic-panel p-6 rounded-2xl space-y-3">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-(--neutral-border) flex-wrap gap-2">
                ...
                <button
                  onClick={() => toggleExpand(idx)}
                  className="text-xs text-(--neutral-weak) hover:text-(--neutral-strong) flex items-center gap-1"
                >
